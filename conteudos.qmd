...
Este talvez seja o módulo que mais se distancia do cotiando de pesquisadores de psicologia e de ciências humanas. Usualmente, trabalhamos com dados que nós coletamos e, ao importá-los ou alimentarmos planilhas, já os temos no formato *tidy* (arrumado). Este formato se refere ao seguinte:
