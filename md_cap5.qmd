...
$$
\begin{aligned}
\widehat{y} = \widehat{\text{life_exp}} &= b_0 + b_{\text{Amer}}\cdot\mathbf{1}_{\text{Amer}}(x) + b_{\text{Asia}}\cdot\mathbf{1}_{\text{Asia}}(x) + \\
& \qquad b_{\text{Euro}}\cdot\mathbf{1}_{\text{Euro}}(x) + b_{\text{Ocean}}\cdot\mathbf{1}_{\text{Ocean}}(x)\\
&= 54.8 + 18.8\cdot\mathbf{1}_{\text{Amer}}(x) + 15.9\cdot\mathbf{1}_{\text{Asia}}(x) + \\
& \qquad 22.8\cdot\mathbf{1}_{\text{Euro}}(x) + 25.9
\cdot\mathbf{1}_{\text{Ocean}}(x)
\end{aligned}
$$
...
$$
\begin{align}
\widehat{\text{life_exp}} &= b_0 + b_{\text{Amer}} \cdot 1_{\text{Amer}}(x) + b_{\text{Asia}} \cdot 1_{\text{Asia}}(x) + \\
...
Em outras palavras, tudo o que resta é o intercepto b_0, correspondente à expectativa de vida média dos países africanos de 54,8 anos. A seguir, digamos que estamos considerando um país das Américas. Neste caso, apenas a função indicadora $1\_{Amer}(x)$ para as Américas será igual a 1, enquanto todas as outras serão iguais a 0, e, portanto:

$$
\begin{align}
\widehat{\text{life_exp}} &= 54.8 + 18.8 \cdot 1_{\text{Amer}}(x) + 15.9 \cdot 1_{\text{Asia}}(x) + 22.8 \cdot 1_{\text{Euro}}(x) + 25.9 \cdot 1_{\text{Ocean}}(x) \\
