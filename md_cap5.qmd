...
```{r}
#| echo: false
#| tbl-cap: Tabela 5.1\:\ Uma amostra aleatória de 5 dos 463 cursos da UT Austin
#| 
evals_ch5 |> 
  slice_sample(n = 5) |>  
  gt() |> 
...
2.  Obtemos a tabela de regressão aplicando a função tidy() do pacote `broom` em `score_model`.
